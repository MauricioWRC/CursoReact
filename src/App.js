      ...
      <div className="form-todo">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-crontol">
            ...
            <input type="text" name='tme' placeholder='Tempo estimado em horas' onChange={(e) => setTime(e.target.value)} value={time || ""} required/>
          </div>
          <input type="submit" value="Criar Tarefa" id='submit' />
        </form>
      </div>
